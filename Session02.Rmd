...
**Side Quest** From Monday Exercise, open a text editor or even excel! And create a metadata file from the small data set that you ran Monday (solution posted on canvas, feel free to run it if you need to do that again!)
...
Because low values might be due to errors in the machine
...
#counts_subset <- subset(counts, counts$SRR1039508>10, counts$SRR1039509>10, counts$SRR1039512>10, counts$SRR1039513>10, counts$SRR1039516>10, counts$SRR1039517>10, counts$SRR1039520>10, counts$SRR1039521>10)
